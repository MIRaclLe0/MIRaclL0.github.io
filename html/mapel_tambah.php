        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="min-height:100vh">
                <div class="card">
                    <div class="card-body">
                        <h3>Tambah mapel</h3>
                        <form action="<?=_url('mapel_tambah');?>" method="post" class="form d-flex flex-wrap">
                            <div class="form-group col-6">
                                <label class="col-md-12">nama mata pelajaran</label>
                                <div class="col-md-12">
                                    <input required name="nama_mapel" type="text"
                            ...
                            <div class="form-group col-2">
                                ...
                                <div class="col-md-12">
                                    <input required name="kkm" type="number" class="form-control form-control-line">
                                </div>
                            </div>
