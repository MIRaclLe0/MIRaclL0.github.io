        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="min-height:100vh">
                <div class="card">
                    <div class="card-body">
                        <h3>Buat materi</h3>
                        <form enctype="multipart/form-data" action="<?=_url('materi_tambah');?>" method="post"
                            class="form d-flex flex-wrap">
...
foreach ($kelas as $m): ?>
                            ...
                            <div class="form-group col-5">
                                <label class="col-md-12">judul materi</label>
                                <div class="col-md-12">
                                    <input required name="judul" type="text" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group col-6">
                                <label class="col-md-12">unggah materi</label>
                                <div class="col-md-12">
                                    <input required name="materi" type="file" class="form-control form-control-line">
                                </div>
                            </div>
