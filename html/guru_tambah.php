        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="min-height:100vh">
                <div class="card">
                    <div class="card-body">
                        <h3>Tambah guru</h3>
                        <form action="<?=_url('guru_tambah');?>" method="post" class="form d-flex flex-wrap">
                            <div class="form-group col-lg-2 col-sm-4">
                                <label class="col-md-12">NIP</label>
                                <div class="col-md-12">
                                    <input required name="nip" type="text" class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-lg-7 col-sm-12">
                                ...
                                <div class="col-md-12">
                                    <input name="nama_guru" type="text" class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-4">
                                ...
                                <div class="col-md-12">
                                    <input name="pendidikan" type="text" class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-6">
                                ...
                                <div class="col-md-12">
                                    <input name="no_telpon" type="text" class="form-control form-control-line">
                                </div>
                            </div>
