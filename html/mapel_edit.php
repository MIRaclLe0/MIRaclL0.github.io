        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="min-height:100vh">
                <div class="card">
                    <div class="card-body">
                        <h3>Edit mapel</h3>
                        <form action="<?=_get('mapel_edit', "?id=$id");?>" method="post" class="form d-flex flex-wrap">
                            <div class="form-group col-6">
                                <label class="col-md-12">nama mata pelajaran</label>
                                <div class="col-md-12">
                                    <input value="<?=$mapel['nama_mapel'];?>" required name="nama_mapel" type="text"
                                        class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group col-2">
                                <label class="col-md-12">kkm</label>
                                <div class="col-md-12">
                                    <input value="<?=$mapel['kkm'];?>" required name="kkm"
                                        placeholder="Contoh: 2021/2022" type="number"
                                        class="form-control form-control-line">
                                </div>
                            </div>
