                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-2">
                            <table class="text-center table v-middle data-out" id="out-1">
                                ...
                                <tbody>
                                    <?php $data = sql("select * from jadwal");
$jadwal = getAll($data);?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
$kelas = $s['id_kelas'];
echo first(sql("select * from kelas where id_kelas=$kelas"))['nama_kelas'];?></td>
                                        <td><?php
$guru = $s['id_guru'];
echo first(sql("select * from guru where id_guru=$guru"))['nama_guru'];?></td>
                                        <td><?php
$mapel = $s['id_mapel'];
echo first(sql("select * from mapel where id_mapel=$mapel"))['nama_mapel'];?></td>
                                        <td
                                            class="<?=$_SESSION['tipe'] == 'Kepala Sekolah' ? 'd-none' : 'd-flex'?> justify-content-center">
                                            <a href="<?=_view('jadwal_edit', '?id=' . $s['id_jadwal']);?>"
                                                class="mx-2 btn btn-success">edit</a>
                                            <a href="<?=_get('jadwal_hapus', '?id=' . $s['id_jadwal']);?>"
