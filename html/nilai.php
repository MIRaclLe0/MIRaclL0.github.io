...
$data = sql("select * from jadwal where id_guru=$id");
$jadwal = getAll($data);?>
...
?>
                                    ...
                                    <tr>
                                        <td>
                                            <?php
$siswa = first(sql("select * from siswa
...
?></td>
                                        ...
                                        <td><?=$n['uas'];?></td>
                                        <td><?=$n['raport'];?></td>
                                        <td><a href="<?=_get('nilai_hapus', '?id=' . $n['id_nilai']);?>"
                                                class="mx-2 btn btn-danger">hapus</a></td>
                                    </tr>
                                    <?php endforeach?>
                                    <?php endforeach?>
                                </tbody>
