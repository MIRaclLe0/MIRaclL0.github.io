        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="min-height:100vh">
                <div class="card">
                    <div class="card-body">
                        <h3>Edit siswa</h3>
                        <form action="<?=_get('siswa_edit', "?id=$id");?>" method="post" class="form d-flex flex-wrap">
                            <div class="form-group col-lg-2 col-sm-4">
                                <label class="col-md-12">NIS</label>
                                <div class="col-md-12">
                                    <input value="<?=$siswa['nis'];?>" required name="nis" type="text"
                            ...
                            <div class="form-group col-lg-3 col-sm-8">
                                ...
                                <div class="col-md-12">
                                    <input value="<?=$siswa['tanggal_masuk'];?>" required name="tanggal_masuk"
                                        type="date" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group col-lg-7 col-sm-12">
                                <label class="col-md-12">nama</label>
                                <div class="col-md-12">
                                    <input value="<?=$siswa['nama_siswa'];?>" name="nama" type="text"
                                        class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-12">
                                ...
                                <div class="col-md-12">
                                    <textarea name="alamat" type="text"
                                        class="form-control form-control-line"><?=$siswa['alamat'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group col-4">
                                ...
                                <div class="col-md-12">
                                    <select name="jk" id="" class="form-control">
                                        <option <?=$siswa['jenis_kelamin'] == "laki-laki" ? "selected" : "";?>>laki-laki
                                        </option>
                                        <option <?=$siswa['jenis_kelamin'] == "perempuan" ? "selected" : "";?>>perempuan
                                        </option>
                                    </select>
                                </div>
                            </div>
...
?>
                            ...
                            <div class="form-group col-4">
                                ...
                                <div class="col-md-12">
                                    <input value="<?=$siswa['agama'];?>" type="text" name="agama" class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-6">
                                <label class="col-md-12">nama ayah</label>
                                <div class="col-md-12">
                                    <input value="<?=$siswa['nama_ayah'];?>" name="ayah" type="text"
                                        class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group col-6">
                                ...
                                <div class="col-md-12">
                                    <input value="<?=$siswa['nama_ibu'];?>" name="ibu" type="text"
                                        class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group col-6">
                                <label class="col-md-12">pekerjaan ayah</label>
                                <div class="col-md-12"><textarea name="p_ayah" type="text"
                                        class="form-control form-control-line"><?=$siswa['pekerjaan_ayah'];?></textarea>
                                </div>
                            </div>
                            <div class="form-group col-6">
                                ...
                                <div class="col-md-12">
                                    <textarea name="p_ibu" type="text"
                                        class="form-control form-control-line"><?=$siswa['pekerjaan_ibu'];?></textarea>
                                </div>
                            </div>
