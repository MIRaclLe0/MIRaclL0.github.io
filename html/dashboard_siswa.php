            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=_page('nilai_siswa');?>"
...
?>
                                        ...
                                        <td><?php $guru = $s['id_guru'];
$guru = first(
    sql("select nama_guru from guru where id_guru=$guru")
);
echo $guru['nama_guru'];
?></td>
                                        <td><?=$s['hari'];?></td>
