        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="min-height:100vh">
                <div class="card">
                    <div class="card-body">
                        <h3>Edit kelas</h3>
                        <form action="<?=_get('kelas_edit', "?id=$id");?>" method="post" class="form d-flex flex-wrap">
                            <div class="form-group col-4">
                                <label class="col-md-12">Kelas</label>
                                <div class="col-md-12">
                                    <input value="<?=$kelas['nama_kelas'];?>" required name="nama_kelas" type="text"
                            ...
                            <div class="form-group col-4">
                                ...
                                <div class="col-md-12">
                                    <input value="<?=$kelas['angkatan'];?>" required name="angkatan"
                                        placeholder="Contoh: 2021/2022" type="text"
                                        class="form-control form-control-line">
                                </div>
                            </div>
