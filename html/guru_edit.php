        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="min-height:100vh">
                <div class="card">
                    <div class="card-body">
                        <h3>Edit guru</h3>
                        <form action="<?=_get('guru_edit', "?id=$id");?>" method="post" class="form d-flex flex-wrap">
                            <div class="form-group col-lg-2 col-sm-4">
                                <label class="col-md-12">NIP</label>
                                <div class="col-md-12">
                                    <input value="<?=$guru['nip'];?>" required name="nip" type="text"
                            ...
                            <div class="form-group col-lg-3 col-sm-8">
                                ...
                                <div class="col-md-12">
                                    <input value="<?=$guru['tanggal_lahir'];?>" required name="tanggal_lahir"
                            ...
                            <div class="form-group col-lg-7 col-sm-12">
                                ...
                                <div class="col-md-12">
                                    <input value="<?=$guru['nama_guru'];?>" name="nama_guru" type="text"
                                        class="form-control form-control-line">
                                </div>
                            </div>
                            ...
                            <div class="form-group col-4">
                                ...
                                <div class="col-md-12">
                                    <select name="jk" id="" class="form-control">
                                        <option <?=$guru['jenis_kelamin'] == "laki-laki" ? "selected" : "";?>>laki-laki
                                        </option>
                                        <option <?=$guru['jenis_kelamin'] == "perempuan" ? "selected" : "";?>>perempuan
                                        </option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group col-4">
                                ...
                                <div class="col-md-12">
                                    <input value="<?=$guru['agama'];?>" type="text" name="agama" class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-4">
                                <label class="col-md-12">pendidikan</label>
                                <div class="col-md-12">
                                    <input value="<?=$guru['pendidikan'];?>" name="pendidikan" type="text"
                                        class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group col-6">
                                ...
                                <div class="col-md-12">
                                    <select name="jabatan" id="" class="form-control">
                                        <option <?=$guru['jabatan'] == "guru" ? "selected" : "";?>>guru</option>
                                        <option <?=$guru['jabatan'] == "kepsek" ? "selected" : "";?>>kepsek</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group col-6">
                                ...
                                <div class="col-md-12">
                                    <input value="<?=$guru['no_telpon'];?>" name="no_telpon" type="text"
                                        class="form-control form-control-line">
                                </div>
                            </div>
