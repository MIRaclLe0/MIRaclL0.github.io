...
if ($_SESSION['tipe'] == 'Guru') {
    _goto("dashboard_guru.php");
} else if ($_SESSION['tipe'] == 'Siswa') {
    _goto("dashboard_siswa.php");
}
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-2">
                            <table class="text-center table v-middle data-out" id="out-1">
                                ...
                                <tbody>
                                    <?php $data = sql("select * from siswa");
$siswa = getAll($data);?>
...
?>
                                        ...
                                        <td
                                            ...
                                            <a href="<?=_view('siswa_edit', '?id=' . $s['id_siswa']);?>"
                                                class="mx-2 btn btn-success">edit</a>
                                            <a href="<?=_get('siswa_hapus', '?id=' . $s['id_siswa']);?>"
