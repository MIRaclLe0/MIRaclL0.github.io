        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="min-height:100vh">
                <div class="card">
                    <div class="card-body">
                        <h3>Tambah kelas</h3>
                        <form action="<?=_url('kelas_tambah');?>" method="post" class="form d-flex flex-wrap">
                            <div class="form-group col-4">
                                <label class="col-md-12">Kelas</label>
                                <div class="col-md-12">
                                    <input required name="nama_kelas" type="text"
                            ...
                            <div class="form-group col-4">
                                ...
                                <div class="col-md-12">
                                    <input required name="angkatan" placeholder="Contoh: 2021/2022" type="text"
                                        class="form-control form-control-line">
                                </div>
                            </div>
