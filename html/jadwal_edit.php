        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid" style="min-height:100vh">
                <div class="card">
                    <div class="card-body">
                        <h3>Tambah jadwal</h3>
                        <form action="<?=_get('jadwal_edit', "?id=$id");?>" method="post" class="form d-flex flex-wrap">
...
foreach ($guru as $k): ?>
                                        <option value="<?=$k['id_guru'];?>"
                                            <?=$jadwal['id_guru'] == $k['id_guru'] ? "selected" : "";?>>
                                            <?=$k['nama_guru'];?>
                                        </option>
                                        <?php endforeach?>
                                    </select>
...
foreach ($mapel as $k): ?>
                                        <option value="<?=$k['id_mapel'];?>"
                                            <?=$jadwal['id_mapel'] == $k['id_mapel'] ? "selected" : "";?>>
                                            <?=$k['nama_mapel'];?>
                                        </option>
                                        <?php endforeach?>
                                    </select>
                            ...
                            <div class="form-group col-4">
                                ...
                                <div class="col-md-12">
                                    <select name="hari" id="" class="form-control">
                                        ...
                                        <option <?=$jadwal['hari'] == "jum'at" ? "selected" : "";?>>jum'at</option>
                            ...
                            <div class="form-group col-4">
                                ...
                                <div class="col-md-12">
                                    <input value="<?=$jadwal['jam'];?>" type="time" class="form-control" name="jam">
                                </div>
                            </div>
