                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mt-2">
                            <table class="text-center table v-middle data-out" id="out-1">
                                ...
                                <tbody>
                                    <?php $data = sql("select * from kelas");
$kelas = getAll($data);?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
$id = $s['id_kelas'];
echo first(sql("select count(*) as c from siswa where kelas=$id"))['c'];
?></td>
                                        <td
                                            class="<?=$_SESSION['tipe'] == 'Kepala Sekolah' ? 'd-none' : 'd-flex'?> justify-content-center">
                                            <a href="<?=_view('kelas_edit', '?id=' . $s['id_kelas']);?>"
                                                class="mx-2 btn btn-success">edit</a>
                                            <a href="<?=_get('kelas_hapus', '?id=' . $s['id_kelas']);?>"
